...
import com.hornet.movies.ui.core.DrawableIcon
import com.hornet.movies.ui.core.LabelText
import com.hornet.movies.ui.core.Spacer16
    ...
    Card(
        ...
        Column {
            Box(Modifier.fillMaxWidth()) {
                ...
                Box(Modifier.matchParentSize().background(Color.Black.copy(alpha = .7f)))
                AsyncImage(
                    modifier = Modifier
                        .padding(Spacing.dp8)
                        .height(104.dp)
